...
Cả ba bài toán trên đều có cách giải rất đơn giản, đó là thế vào và thử, tuy nhiên độ phức tạp tính toán sẽ rất cao, nên người ta dùng kỹ thuật quy hoạch động (<a href="https://en.wikipedia.org/wiki/Dynamic_programming" target="_blank">dynamic programming</a>) để tối ưu, giúp giải quyết cả 3 vấn đề một cách quy nạp và theo thời gian đa thức. Cụ thể bài toán 1 có thể giải với thuật toán <a href="https://en.wikipedia.org/wiki/Forward%E2%80%93backward_algorithm" target="_blank">forard-backward</a>, bài toán 2 sẽ giải bằng thuật toán <a href="https://en.wikipedia.org/wiki/Viterbi_algorithm" target="_blank">Viterbi</a> và bài toán 3 sẽ giải bằng thuật toán <a href="https://en.wikipedia.org/wiki/Baum%E2%80%93Welch_algorithm" target="_blank">Baum-Welch</a>.
